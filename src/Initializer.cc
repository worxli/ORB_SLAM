...
<<<<<<< HEAD
    ...
    gR =(cv::Mat_<float>(3,3) << 0.5, 0, 1, -1, 0, 0, 0, -1, 2);
    //gt =(cv::Mat_<float>(3,1) << 1.8693504635, 0.7787120638, 0.8834578976);
    gt =(cv::Mat_<float>(3,1) << 2, 1, 1);
...
>>>>>>> 86566656c7e705bfe045c5a8904c6acf47ad3d34
...
<<<<<<< HEAD
        //cout << "Check RT error " << squareError1 << endl;
...
<<<<<<< HEAD
        //cout << "CheckRT vP3D: " << vP3D[vMatches12[i].first] << endl;
=======
>>>>>>> 86566656c7e705bfe045c5a8904c6acf47ad3d34
        nGood++;
