...
As offline presentation we have ros bags available with recorded data of a monocular camera and multiple cameras. We will present our algorithm offline with the image data from multiple cameras. Additionally, we will demonstrate our modified algorithms online with a 8-camera-system.   
